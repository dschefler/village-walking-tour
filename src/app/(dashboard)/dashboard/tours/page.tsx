...
export default async function DashboardToursPage() {
  ...
  const orgData = membership.organization as unknown as { slug: string } | null;
              ...
              <Card key={tour.id} className="overflow-hidden">
                  ...
                  <div className="relative aspect-video">
                    ...
                    <div className="absolute top-2 right-2">
                      <span className={`px-2 py-1 text-xs rounded-full ${
                        tour.is_published ? 'bg-green-500 text-white' : 'bg-amber-500 text-white'
                      }`}>
                ...
                <CardContent>
                  <div className="flex gap-2">
                    ...
                    {tour.is_published && orgSlug && (
                      <Button variant="outline" size="sm" asChild>
                        <Link href={`/t/${orgSlug}/tour/${tour.slug}`} target="_blank">
