...
export function CuratedTourClient({ orgSlug, tour }: CuratedTourClientProps) {
  ...
  const clearAll = () => { setSelectedIds(new Set()); setTourCreated(false); setCreatedRoute([]); setMapboxFailed(false); };
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <header className="text-white py-8" style={{ backgroundColor: primaryColor }}>
        <div className="container mx-auto px-4">
          ...
          <p className="opacity-90 max-w-2xl">{tour.description}</p>
        </div>
      </header>
          ...
          <div className="lg:sticky lg:top-20 lg:h-[calc(100vh-160px)] space-y-4">
            {selectedIds.size === 0 ? (
              <div className="bg-white rounded-lg shadow-lg p-8 h-full min-h-[400px] flex flex-col items-center justify-center text-center">
                ...
                <p className="text-gray-500">Select sites from the list to build your route.</p>
              </div>
            ) : !tourCreated ? (
              <div className="bg-white rounded-lg shadow-lg p-8 h-full min-h-[400px] flex flex-col items-center justify-center text-center">
                ...
                <p className="text-gray-500 mb-4">Ready to create your optimized route?</p>
