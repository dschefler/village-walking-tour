          ...
          <div className="lg:sticky lg:top-20 lg:h-[calc(100vh-160px)]">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden h-full min-h-[400px]">
              <HistoricSitesMap
                ...
                onSiteClick={(site) => {
                  window.location.href = `/location/${site.slug || site.id}`;
                }}
              />
            </div>
          </div>
              ...
              {sites.map((site) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`
                        bg-white rounded-lg shadow-sm border-2 transition-all duration-200 overflow-hidden
                        hover:shadow-lg hover:border-[#A40000] cursor-pointer
                        ${hoveredSiteId === site.id ? 'border-[#A40000] shadow-lg' : 'border-transparent'}
                      `}
                    >
                      <div className="flex">
                        {/* Image */}
                        ...
                        <div className="flex-1 p-4 flex flex-col justify-between">
                          <div>
                            ...
                            {site.address && (
                              <p className="text-sm text-[#014487] flex items-center gap-1 mb-2">
                          ...
                          <div className="flex items-center justify-between mt-2">
                            <div className="flex items-center gap-2">
                              {site.audio_url && (
                                <span className="inline-flex items-center gap-1 text-xs text-[#A40000]">
                                  <Volume2 className="w-3 h-3" />
                                  Audio
                                </span>
                              )}
                            </div>
                            <span className="text-[#A40000] text-sm font-medium flex items-center">
                              View Details
